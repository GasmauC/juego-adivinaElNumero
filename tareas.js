...
function indiceMasaMuscular(metros,peso){
    let indice = peso/(metros*metros)
    console.log(`Su indice de masa corporal es de: ${indice}`);
}
indiceMasaMuscular(1.83,97);
...
var resultado = calcularFactorial(7);
